...
# model settings
custom_imports = dict(imports=['mmpose.models'], allow_failed_imports=False)
model = dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[
            dataset_onehand10k, dataset_freihand
